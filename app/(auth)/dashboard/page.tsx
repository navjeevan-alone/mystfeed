        ...
        <div className="dashboard">
           <Navbar></Navbar>
            <div className="container sm:mt-12 mt-4 ">
                <h1 className="text-4xl text-left  mb-4">User Dashboard</h1>
                <h2 className="text-xl text-left mb-2 pl-1">Share your unique link</h2>
                <UserLink userLink={"user link"} />
                <div className="flex items-center space-x-2 my-4">
                    <Switch id="allow-feedback"/>
                    <Label htmlFor="allow-feedback" className="text-md cursor-pointer">Allow people to send feedbacks</Label>
                </div>
            </div>
